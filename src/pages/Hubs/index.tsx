...
const Hubs = () => {
  // Lọc theo danh mục Hub chuyển đổi
  const hubsProducts = electronicsData.filter(
    (product) => product.category === "Hub chuyển đổi"
  );
  ...
  const featuredProducts = [...hubsProducts]
  ...
  return (
    <div className="min-h-screen bg-gray-50 mt-20">
      ...
      <section className="mx-auto max-w-8xl px-4 sm:px-6">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-purple-600 via-fuchsia-500 to-pink-600 p-6 sm:p-8 shadow-sm">
          <div className="grid gap-4 sm:grid-cols-[1.3fr_1fr] sm:items-center">
            <div className="min-w-0">
              ...
              <p className="mt-2 sm:mt-3 text-white/90">
                Các loại hub và bộ chuyển đổi chất lượng cao, hỗ trợ nhiều cổng kết nối và chuẩn giao tiếp hiện đại.
              </p>

              <div className="mt-4 flex flex-wrap items-center gap-2">
                <Link
                  to="/"
                  className="inline-flex items-center rounded-lg bg-white/95 px-3 py-2 text-sm font-semibold text-purple-700 shadow-sm ring-1 ring-black/5 transition hover:bg-white"
                >
      ...
      {featuredProducts.length > 0 && (
        <section className="mx-auto mt-8 max-w-8xl px-4 sm:px-6">
          <div className="mb-5 sm:mb-6">
            <SectionTitle>Hub chuyển đổi nổi bật</SectionTitle>
          </div>
      ...
      <section className="mx-auto mt-8 max-w-8xl px-4 sm:px-6">
        <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <SectionTitle>Tìm kiếm Hub chuyển đổi</SectionTitle>
          ...
          <div className="grid min-h-[200px] place-items-center rounded-2xl border border-dashed border-gray-200 bg-white/60 p-10 text-center">
            <div>
              ...
              <div className="mt-3">
                <Link
                  to="/"
                  className="inline-flex items-center rounded-lg bg-purple-600 px-3 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-purple-700"
                >
                  Về trang chủ danh mục
                </Link>
              </div>
