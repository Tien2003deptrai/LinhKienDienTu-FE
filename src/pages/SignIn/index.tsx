  ...
  return (
    <section className="h-screen">
      ...
      <div className="container mx-auto h-full px-6 py-12">
        <div className="g-6 flex h-full flex-wrap items-center justify-center text-gray-800 xl:justify-center">
            ...
            <form onSubmit={submitHandler}>
              <div className="mb-4 flex flex-row items-center justify-center lg:justify-start">
                ...
                <button
                  ...
                  data-mdb-ripple="true"
                  data-mdb-ripple-color="light"
                  className="mx-1 inline-block rounded-full bg-blue-700 p-3 text-xs font-medium uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:bg-blue-800 hover:shadow-lg focus:bg-blue-800 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-900 active:shadow-lg"
                >
