...
const ChargingComponents = () => {
  // Lọc theo danh mục Linh kiện sạc điện thoại
  const chargingProducts = electronicsData.filter(
    (product) => product.category === "Linh kiện sạc điện thoại"
  );
  ...
  const featuredProducts = [...chargingProducts]
  ...
  return (
    <div className="min-h-screen bg-gray-50 mt-20">
      ...
      <section className="mx-auto max-w-8xl px-4 sm:px-6">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-emerald-600 via-green-500 to-teal-600 p-6 sm:p-8 shadow-sm">
          <div className="grid gap-4 sm:grid-cols-[1.3fr_1fr] sm:items-center">
            <div className="min-w-0">
              ...
              <h1 className="mt-1 text-2xl sm:text-3xl md:text-4xl font-extrabold leading-tight text-white">
                Linh kiện sạc điện thoại
              </h1>
              <p className="mt-2 sm:mt-3 text-white/90">
                Các loại linh kiện sạc điện thoại chất lượng cao, bao gồm cốc sạc, cáp sạc, pin dự phòng và nhiều hơn nữa.
              </p>

              <div className="mt-4 flex flex-wrap items-center gap-2">
                <Link
                  to="/"
                  className="inline-flex items-center rounded-lg bg-white/95 px-3 py-2 text-sm font-semibold text-emerald-700 shadow-sm ring-1 ring-black/5 transition hover:bg-white"
                >
      ...
      {featuredProducts.length > 0 && (
        <section className="mx-auto mt-8 max-w-8xl px-4 sm:px-6">
          <div className="mb-5 sm:mb-6">
            <SectionTitle>Linh kiện sạc nổi bật</SectionTitle>
          </div>
      ...
      <section className="mx-auto mt-8 max-w-8xl px-4 sm:px-6">
        <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <SectionTitle>Tìm kiếm Linh kiện sạc</SectionTitle>
          ...
          <div className="grid min-h-[200px] place-items-center rounded-2xl border border-dashed border-gray-200 bg-white/60 p-10 text-center">
            <div>
              ...
              <div className="mt-3">
                <Link
                  to="/"
                  className="inline-flex items-center rounded-lg bg-emerald-600 px-3 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-emerald-700"
                >
                  Về trang chủ danh mục
                </Link>
              </div>
...
export default ChargingComponents;
